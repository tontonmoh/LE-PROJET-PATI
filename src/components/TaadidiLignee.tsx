 ...
 * Fond CLAIR : les figures (detourees depuis du creme) s'y fondent sans halo.
 *
...
const STOPS: {
  ...
  { key: "nourrisson", img: "/images/taadidi/taadidi-age1-nourrisson.png", phase: "Nouvelle lune", age: "Le nourrisson", line: "Il épargne sa mère, il rampe vers son père.", moon: "new", h: 118 },
  { key: "enfant", img: "/images/taadidi/taadidi-age2-enfant.png", phase: "Premier quartier", age: "L'enfant", line: "Il grandit, il observe.", moon: "first", h: 162 },
  { key: "ado", img: "/images/taadidi/taadidi-age3-ado.png", phase: "Pleine lune", age: "L'adolescent", line: "Il protège, il déjoue.", moon: "full", h: 198 },
  ...
  { key: "sogue", img: "/images/taadidi/taadidi-sogue.png", phase: "Le soleil", age: "Sogué", line: "Sa fille — la source.", moon: "sun", h: 104, coda: true },
];
  ...
  return (
    <section style={{ padding: "3.5rem 1rem", background: "#FFF6E7" }}>
      <style>{`
        ...
        .tdln-sub{color:#3a4a42;max-width:48ch;margin:0 0 1.6rem;font-size:1rem;line-height:1.55}
        ...
        .tdln-stop{flex:1 0 156px;scroll-snap-align:center;display:flex;flex-direction:column;
          align-items:center;padding:1.2rem .6rem 1.3rem;text-align:center;min-width:156px}
        .tdln-coda{box-shadow:inset 1px 0 0 rgba(13,43,26,.10)}
        .tdln-figwrap{height:232px;display:flex;align-items:flex-end;justify-content:center}
        ...
        .tdln-line{color:#4a5a50;font-size:.84rem;line-height:1.4;max-width:18ch}
        .tdln-foot{color:#6b7a70;font-size:.82rem;margin:1.1rem 0 0;text-align:center}
      ...
      <div className="tdln-wrap">
        ...
        <p className="tdln-sub">
          Du croissant à la source : Taadidi grandit avec la lune, jusqu'au soleil
          qu'il nomme Sogué. Fais glisser pour parcourir sa vie.
        </p>
        ...
        <p className="tdln-foot">Kiké → Sogué · de la lune au soleil, en vingt-huit épisodes.</p>
      </div>
    </section>
  );
}
