    ...
    <div className="bg-[#FFF6E7] min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
          {tomes.map((t) => {
            const meta = [`Épisode ${t.numero}`, t.lieu, t.odd?.length ? `ODD ${t.odd.join(", ")}` : null].filter(Boolean).join(" · ");
              ...
              return (
                <Link key={t.numero} to={t.to} className="card-kid group overflow-hidden">
                  <div className="relative aspect-[3/4] overflow-hidden">
                    ...
                    <span className="absolute top-2 left-2 inline-flex items-center justify-center h-6 px-2 text-[11px] font-bold text-white rounded-full shadow-kid" style={{ background: G2040.accent }}>Épisode {t.numero}</span>
