...
export const POINT_ZERO = {
  ...
  tomes: [
    ...
    { numero: 2, titre: "Le partage des cousins", sousTitre: "Le sud", lieu: "Malabo · Guinée équatoriale", statut: "live", to: "/livre/point-zero-t2/lire", cover: "/images/point-zero/point-zero-t2-couverture.webp", coverLandscape: "/images/point-zero/point-zero-t2-couverture.webp" },
