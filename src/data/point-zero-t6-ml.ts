...
export const POINT_ZERO_T6_ML: Partial<Record<Lang, RBook>> = {
  fr: {
    ...
    { title: "", image: "/images/point-zero/pz6-02.webp", paragraphs: [
        "Un soir, je les ai sentis venir. Deux enfants, une coque rouge dans la main. Sur l'île de Tamara, le phare tournait, comme depuis plus de cent ans.",
    ...
    { title: "", image: "/images/point-zero/pz6-04.webp", paragraphs: [
        "Au bord de l'eau, Djènè a hésité. Le point zéro, c'est loin du rivage. Plus loin que la plongée d'un enfant qui sait nager.",
        "Bangaly, lui, ne s'est pas arrêté. Il a retiré sa chemise. Il regardait l'eau comme on regarde une ligne qu'on connaît depuis toujours.",
        "« Suis-moi, dit-il. Je sais comment elle respire. »",
        "Il est entré le premier. C'est l'île, depuis l'enfance, qui lui avait appris.",
    ] },
    { title: "", image: "/images/point-zero/pz6-05.webp", paragraphs: [
        "Ils ont nagé jusque-là où le ciel touche l'eau. Là où je suis tombée.",
        "Et puis ils ont plongé. Bangaly devant, Djènè qui suivait sa trace dans le noir. Plus bas. Plus bas que la lumière ne descend.",
        "Jusqu'à moi.",
    ...
    { title: "", image: "/images/point-zero/pz6-06.webp", paragraphs: [
        ...
        "Mais ce n'est pas tout ce qui s'est passé sous l'eau.",
        "Le garçon, en me touchant, a baissé les yeux. Quelque chose en lui a reconnu quelque chose en moi.",
        "Il n'a pas dit un mot. Mais une phrase, longtemps avant, lui était sortie de la bouche sans qu'il sache d'où elle venait. C'était la mienne. La nuit où j'avais décidé.",
        "Il a toujours su. Il ne l'avait juste pas encore appris.",
    ] },
    { title: "", image: "/images/point-zero/pz6-07.webp", paragraphs: [
        ...
        "Cette fois, elle n'est pas restée.",
        "Sa lumière a glissé du ciel jusqu'à la mer, douce, prudente — la lumière d'une sœur qui n'avait pas osé, et qui ose enfin. Pas pour se sacrifier. Pour voir. Pour la première fois.",
        "Elle m'a trouvée.",
        "Deux jumelles, enfin, dans la même eau.",
    ] },
    { title: "", image: "/images/point-zero/pz6-08.webp", paragraphs: [
        "Et partout dans le monde, ceux qui veillaient ont senti.",
        "À Bijagós, Damba a posé sa main sur le sable. Les oiseaux migrateurs sont passés au-dessus d'elle, et leur cri était autre.",
        "À Bioko, dans la forêt humide, Ngo s'est arrêtée. Les colobes rouges, autour d'elle, se sont tus une seconde. Un seul battement.",
        "Sur son île, au fond du Pacifique, Papou a déployé ses ailes. L'or, le violet, le noir profond — il a brillé une fois, pour rien, juste pour le ciel.",
        "Et sur la terre des eaux, au bord d'une rizière, Awa a relevé la tête. Elle souriait sans savoir pourquoi.",
        "Tous l'avaient sentie. Aucun ne l'avait su.",
    ] },
    { title: "", image: "/images/point-zero/pz6-09.webp", paragraphs: [
        ...
        "Et dans la grande montagne, au fond du pays. Celle dont les gens parlaient sans la nommer. Celle qui attendait son tour.",
    ...
    { title: "", image: "/images/point-zero/pz6-12.webp", paragraphs: [
    ...
    { title: "", image: "/images/point-zero/pz6-13.webp", paragraphs: [
        "Bangaly est resté à Kassa. C'était son île, et désormais, il y avait quelque chose à veiller.",
        "Moi, je suis rentrée à Conakry. La ville était comme avant. Les klaxons, la poussière rouge, les marchandes au bord des trottoirs. Mais ce n'était plus la même ville. Ou c'était moi qui n'étais plus la même.",
        "Lucas m'attendait. Mon grand-père. Il a levé les yeux quand je suis entrée.",
        "« Alors ? a-t-il dit.",
        "— Tu savais, Lucas.",
        "— Pas savais. Espérais. Ce n'est pas la même chose. »",
        "Sur son mur, parmi d'autres, une vieille photo. Le phare. Cinquante ans avant. Je ne l'avais jamais regardée.",
    ] },
    { title: "", image: "/images/point-zero/pz6-14.webp", paragraphs: [
