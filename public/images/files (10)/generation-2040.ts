...
// Tomes 0 et 1 en ligne ; les suivants à paraître. Titres connus : Tome 1 (Lola) et Tome 4 (Fouta).
...
export const G2040 = {
  ...
  tomes: [
    ...
    { numero: 1, statut: "live", titre: "La Forêt et le Fer", lieu: "Lola", odd: [15, 9], to: "/livre/g2040-foret-et-fer/lire" },
